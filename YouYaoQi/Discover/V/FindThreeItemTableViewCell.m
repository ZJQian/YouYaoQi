...
@interface FindThreeItemTableViewCell ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
@end
@implementation FindThreeItemTableViewCell
...
- (void)setSubViews {
    ...
    [self.collect registerClass:[ThreeItemCell class] forCellWithReuseIdentifier:@"findThreeCell"];
}
...
- (UICollectionView *)collect {
    return C_LAZY(_collect, ({
        ...
        UICollectionView *c = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, h) collectionViewLayout:layout];
...
- (nonnull __kindof UICollectionViewCell *)collectionView:(nonnull UICollectionView *)collectionView cellForItemAtIndexPath:(nonnull NSIndexPath *)indexPath {
    static NSString *cellID = @"findThreeCell";
    ThreeItemCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:cellID forIndexPath:indexPath];
